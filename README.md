...
Making using of the ArduinoJSON library to dynamically create the payload message, which is in my opinion a more elegant way of creating the payload message. Also, the Wemos D1 Mini has plenty of pins available to add a BME280/BMP280 sensor board or a DS18B20 temperature sensor. The code can easily be adapted to accomodate these sensors.
